...
<t:template_cust titre="Ma première page">
    ...
    <h3 style="text-align: center; ">Update User ${user.getFirstName()}</h3>
    ...
    <form  method="POST" action="${pageContext.request.contextPath}/update">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control form-control-user" name="lastName" value= "${user.getLastName()}"  id="exampleLastName" placeholder=" Last Name">
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6 mb-3 mb-sm-0">
                <input type="text" class="form-control form-control-user" name="username" value= "${user.getUsername()}"  id="exampleUsename" placeholder=" Username">
            </div>
            
            <div class="col-sm-6">
                <input type="text" class="form-control form-control-user" name="telephone" value= "${user.getTelephone()}"   id="exampleTelephone" placeholder=" Phone Number">
            </div>
        ...
        <div class="form-group row">
            <div class="col-sm-6">
                <input type="email" class="form-control form-control-user" name="email" value= "${user.getEmail()}"  id="exampleInputEmail" placeholder="E-mail adress">
            </div>
            
            <div class="col-sm-6 mb-3 mb-sm-0">
                <input type="password" class="form-control form-control-user" name="password" value= "${user.getPassword()}"  id="exampleInputPassword" placeholder="Password">
            </div>                      
        </div>
        ...
        <div class="form-group row">
            <div class="col-sm-6">
                <select required name="enable" id="" class="form-control">
                    <option name="enable" value=" "> -- enable --    </option>
