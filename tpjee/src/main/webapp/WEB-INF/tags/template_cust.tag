...
<html lang="en">
    ...
    <%@attribute name="container_fluid" fragment="true"%>
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-warning sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="${pageContext.request.contextPath}/">
                    ...
                    <div class="sidebar-brand-text mx-3">IFNTI
                    </div>
                </a>
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="/tp/indexPage">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="${pageContext.request.contextPath}/users">List of Users</a>
                            <a class="collapse-item" href="${pageContext.request.contextPath}/roles">List of Roles</a>
                            <a class="collapse-item" href="${pageContext.request.contextPath}/fonctions">List of features</a>
                        </div>
                    </div>
                </li>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <img class="img-profile rounded-circle" src="<c:url value="img/profile.jpg"/>"/>
                                </a>
                    ...
                    <div class="container-fluid">
                        <jsp:invoke fragment="container_fluid"/>
                    </div>
